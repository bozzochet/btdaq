...
#	echo $i;
#	echo ${i:0:10}
	echo ./Decode ${i:0:10} 0 --rootdata /data/bt_dampe_jun2015/RootData_$SUFFIX/ --rawdata Data_$SUFFIX --caldata Calibrations_$SUFFIX/
	./Decode ${i:0:10} 0 --rootdata /data/bt_dampe_jun2015/RootData_$SUFFIX/ --rawdata Data_$SUFFIX --caldata Calibrations_$SUFFIX/
    done
