...
public:
  ...
  virtual int GetTdrNum(size_t tdrpos) = 0;
  virtual int GetTdrType(size_t tdrpos) = 0;
  virtual int GetJinfNum(size_t tdrpos) = 0;

  virtual int FindPos(int tdrnum, int jinfnum) = 0;
  virtual int FindJinfPos(int jinfnum) = 0;
...
public:
  ...
  int GetTdrNum(size_t tdrpos) final;
  int GetTdrType(size_t tdrpos) final;
  int GetJinfNum(size_t tdrpos) final;

  int FindPos(int tdrnum, int jinfnum) final;
  int FindJinfPos(int jinfnum) final;
