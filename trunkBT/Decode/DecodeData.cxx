...
void DecodeData::OpenFile(const char *ifname, const char *caldir, int run, int ancillary) {
...
void DecodeData::OpenFile_data(const char *ifname, const char *caldir, int run, int ancillary) {
...
void DecodeData::OpenFile_mc(const char *ifname) {
