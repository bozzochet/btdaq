//  $Id: gmat.C,v 1.2 2008/07/30 16:51:41 zuccon Exp $
// Author V.Choutko.
...
#endif
   //PZ FIXME    uwbuf[0]=TRDMCFFKEY.g3trd;
#ifdef __G4AMS__
    }
#endif
    //PZ FIXME   uwbuf[1]=TRDMCFFKEY.mode;
    uwbuf[3]=0;
    uwbuf[4]=0;
...
//   }
  ...
  //
  {
   ...
   //PZ FIXME  pgtmed->CUTGAM(ECMCFFKEY.cutge);// special cuts for EC_RADIATOR
...
//     }
  ...
  //--------------------
  {
    // ---> AMS02 Magnet Media:
    //
    //FIXME PZ    geant cutge=MAGSFFKEY.ecutge;// increased EgammaEelectron cut
    geant cutge=0.0005;
