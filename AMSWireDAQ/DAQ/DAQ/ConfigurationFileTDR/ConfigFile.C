...
int main(int argc, char ** argv) {
  ...
  if(argc!=8){
    printf("Usage: %s  <input_txt_file> <S1HighThresh> <S1LowThresh> <S2HighThresh> <S2LowThresh> <KHighThresh> <KLowThresh> \n",argv[0]);
...
int CreateScript(){
  ...
  int confname=0x6001;//0x because the names of the files on flash are hexadecimal
