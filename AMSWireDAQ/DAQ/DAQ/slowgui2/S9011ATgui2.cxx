...
void SlowGui::CreateS9011ATFrame(TGCompositeFrame *frame) {
  ...
  TGPictureButton *dcdc=CreateReInitDCDCButton(vframetools,"S9011AT",0);
  TGPictureButton *s9053=CreateS9053HotColdButton(vframetools,"S9011AT",0);
  TGPictureButton *s9053b=CreateS9053HotCold2Button(vframetools,"S9011AT",0);
  TGPictureButton *dcdcoff=CreateAnalogicalSwitchoffButton(vframetools,"S9011AT",0);

  vframetools->AddFrame(refr, fL35);
  vframetools->AddFrame(init, fL35);
  vframetools->AddFrame(dcdc, fL35);
  vframetools->AddFrame(s9053, fL35);
  vframetools->AddFrame(s9053b, fL35);
  vframetools->AddFrame(dcdcoff, fL35);
  ...
  BuildActelDisplay2(hframe, &(tS9011ATActelHot0Button), &(tS9011ATActelCold0Button),&(tS9011ATActelHot1Button), &(tS9011ATActelCold1Button), &(tS9011ATTripIndicator), &(tS9011ATPowerOnIndicator), 0, "S9011AT");
...
void SlowGui::DisplayS9011atStatus() {
  ...
  Int_t mode=ActelMask & 1;
  tS9011ATActelHot0Button->SetBackgroundColor(PixelColor[(mode)?kMyGreen:kMyRed][0]);
  mode=ActelMask & 2;
  tS9011ATActelCold0Button->SetBackgroundColor(PixelColor[(mode)?kMyGreen:kMyRed][0]);
  mode=ActelMask & 4;
  tS9011ATActelHot1Button->SetBackgroundColor(PixelColor[(mode)?kMyGreen:kMyRed][0]);
  mode=ActelMask & 8;
  tS9011ATActelCold1Button->SetBackgroundColor(PixelColor[(mode)?kMyGreen:kMyRed][0]);
  gClient->NeedRedraw(tS9011ATActelHot0Button);
  gClient->NeedRedraw(tS9011ATActelCold0Button);
  gClient->NeedRedraw(tS9011ATActelHot1Button);
  gClient->NeedRedraw(tS9011ATActelCold1Button);
  ...
  ushort trips=FindParameter(0x2402);
  ushort trip9051=trips & 0xff;
  ushort trip9053=(trips>>8) & 0xf;
  ushort trip9055=(trips>>12);
...
void SlowGui::ShowS9011atEmpty() {
  ...
  tS9011ATActelHot0Button->SetBackgroundColor(PixelColor[kMyYellow][0]);
  tS9011ATActelCold0Button->SetBackgroundColor(PixelColor[kMyYellow][0]);
  tS9011ATActelHot1Button->SetBackgroundColor(PixelColor[kMyYellow][0]);
  tS9011ATActelCold1Button->SetBackgroundColor(PixelColor[kMyYellow][0]);
  tS9011ATActelHot0Button->SetEnabled(kFALSE);
  tS9011ATActelCold0Button->SetEnabled(kFALSE);
  tS9011ATActelHot1Button->SetEnabled(kFALSE);
  tS9011ATActelCold1Button->SetEnabled(kFALSE);
  gClient->NeedRedraw(tS9011ATActelHot0Button);
  gClient->NeedRedraw(tS9011ATActelCold0Button);
  gClient->NeedRedraw(tS9011ATActelHot1Button);
  gClient->NeedRedraw(tS9011ATActelCold1Button);
