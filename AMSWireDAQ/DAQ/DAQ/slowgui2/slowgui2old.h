...
class SlowGui {
 ...
 private:
  ...
  TGHProgressBar *fHProgressLeak[4][NTdrTPSFE];
  ...
  void BuildActelDisplay2(TGCompositeFrame *hframe, TGTextButton **button1, TGTextButton **button2, TGTextButton **button3, TGTextButton **button4, TGLabel **label1, TGLabel **label2, Int_t page, Char_t *type);

  int AMSWmode, AMSWportA, AMSWportB;
  int XTANT;

 public:
  SlowGui(const TGWindow *p, UInt_t w, UInt_t h, int tcrate, int octant, unsigned int jinfaddra, unsigned int jinfaddrb, int porta, int portb );
  virtual ~SlowGui();
  ...
  TGPictureButton* CreateInitLecroyButton(TGCompositeFrame *hmain, Char_t *item, Int_t val2);
  TGPictureButton* CreateReInitDCDCButton(TGCompositeFrame *hmain, Char_t *item, Int_t val2);
  TGPictureButton* CreateS9053HotColdButton(TGCompositeFrame *hmain, Char_t *item, Int_t val2);
  TGPictureButton* CreateS9053HotCold2Button(TGCompositeFrame *hmain, Char_t *item, Int_t val2);
  TGPictureButton* CreateAnalogicalSwitchoffButton(TGCompositeFrame *hmain, Char_t *item, Int_t val2);
  TGPictureButton* CreateS9011ActelSwitchButton(TGCompositeFrame *hmain, Char_t *item, Int_t val2);
  ...
  void CreatePlot();
  void NewCanvas(Int_t x, Int_t y, Char_t *name="");
  ...
  void TrackerMonitor(int tcrate=0, int octant=0);
  ...
  //void readlist();
  //int getladder(int x, int xtant, int pwg, int pwgpos);
