...
public:
	...
	int roc_dummy();
	int open_file (char * run_number_name, bool ped_dat=false);
	int open_file (int run_number, bool ped_dat=false);
	...
	string compose_name (char * run_number_name, bool ped_dat=false);
	string compose_name (int run_number, bool ped_dat=false);
	...
	STATIC_CONST double loop_time_out = 10.;//s
