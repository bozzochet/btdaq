...
// - inputs command in nice format
// - converts it into I/O segment
// - sends it to SDR2
//
// A.Lebedev Oct-2006...
...
int main(int argc, char *argv[]) {
  ...
  printf("Usage: %s <TX&RX> <link address> [<data>]\n", argv[0]);
  if (argc < 3) {
