...
int jtag_step(int TMS, int TDI) {
  ...
  exec_SDR2_SC_command(WRITE, board, 0x2C8, wri, NULL, NULL, &err);
  ...
  exec_SDR2_SC_command(READ,  board, 0x2C8, 0, &rea, NULL, &err);
...
int main(int argc, char *argv[]) {
  ...
  exec_SDR2_SC_command(WRITE, board, 0x2C7, 1, NULL, NULL, &err);
