/****************************************************************************
** Image collection for project 'TDisplay'.
**
...
class MimeSourceFactory_TDisplay : public QMimeSourceFactory
{
public:
    MimeSourceFactory_TDisplay() {}
    ~MimeSourceFactory_TDisplay() {}
...
void qInitImages_TDisplay()
{
    if ( !factory ) {
	factory = new MimeSourceFactory_TDisplay;
	QMimeSourceFactory::defaultFactory()->addFactory( factory );
    }
}

void qCleanupImages_TDisplay()
{
    if ( factory ) {
...
class StaticInitImages_TDisplay
{
public:
    StaticInitImages_TDisplay() { qInitImages_TDisplay(); }
#if defined(Q_OS_SCO) || defined(Q_OS_UNIXWARE)
    ~StaticInitImages_TDisplay() { }
#else
    ~StaticInitImages_TDisplay() { qCleanupImages_TDisplay(); }
#endif
};

static StaticInitImages_TDisplay staticImages;
