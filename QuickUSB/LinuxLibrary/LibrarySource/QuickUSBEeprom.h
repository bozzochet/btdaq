...
#define PATCHED_DEFAULTS   0x0100
#define PATCHED_CUSTOMIZER 0x0200
#define PATCHED_GPIF       0x0400

/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  External variable declarations
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

extern QRETURN QuickUsbReadEepromData(QHANDLE hDevice, 
                                         QWORD address, 
                                         QBYTE *data, 
                                         QWORD *length);
extern QRETURN QuickUsbWriteEepromData(QHANDLE hDevice, 
                                          QWORD address, 
                                          QBYTE *data, 
                                          QWORD length);
