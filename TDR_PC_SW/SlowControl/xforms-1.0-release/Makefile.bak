...
# -----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf..Va4KY>
...
IMAKE_DEFINES	= \
		  ...
		  -DSolaris64Bit=0 \
		  -DDoWall=0 \
		  -DXFormsNonstandardInstallDir=/usr/local \
		  -DInstallNonstandard=0 \
		  -DNonstandardXpm=0 \
		  -DXpmIncLoc=/usr/local/include \
		  -DXpmLibLoc=/usr/local/lib \
		  -DNonstandardTiff=0 \
		  -DTiffIncLoc=/usr/local/include \
		  -DTiffLibLoc=/usr/local/lib \
		  -DNonstandardJpeg=0 \
		  -DJpegIncLoc=/usr/local/include \
		  -DJpegLibLoc=/usr/local/lib \
		  -DXFormsLibRev=1.0
