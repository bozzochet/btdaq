// file config-old.c
//
// Obsolete universal program to write config file into USCM
//
// A.Lebedev Jul-2008...
...
static struct _ADC *adc;

static uint8 cceb_model;
static _osc OSC;

static _cc cc_source[4], cc_converted[4];
static _dallas_t_table dallas_t_table[2];
static _cernox_t_table cernox_t_table[3];
...
static void pack_item(const uint8 siz, const void *adr, uint8 **p) {
...
static void write_CCEB_task_parameters(_osc *OSC, _cc *cc, int16 *err) {
